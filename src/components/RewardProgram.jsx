...
const rewards = [
  { id: 1, title: '1 KG For', value: 10, category: 'Cash' },
  { id: 2, title: '5 KG For', value: 50, category: 'Cash' },
  { id: 3, title: '10 KG For', value: 100, category: 'Cash' },
              ...
              .map((reward) => (
                <div key={reward.id} className="reward-card">
                  <div className="reward-info">
                    ...
                    <div className="reward-value">{reward.value} pts</div>
                  </div>
                  <button
